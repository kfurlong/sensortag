...
package/lib/lib/release_full/boot/cmain.orm4: cmain.s lib/release_full/boot.arm4.mak
	...
	$(RM) $@
	@$(MSG) asmrm4 $< ...
	LC_ALL=C $(iar.targets.arm.M4.rootDir)/bin/iasmarm -S --cpu Cortex-M4 --endian little  -Dxdc_target_name__=M4 -Dxdc_target_types__=iar/targets/arm/std.h -Dxdc_bld__profile_release_full -Dxdc_bld__vers_1_0_7_40_2   $(XDCINCS)  -o $@  $<
